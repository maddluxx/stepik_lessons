...
class TestAbs(unittest.TestCase):
    def test_abs1(self):
        try:
            ...
            self.assertEqual("Congratulations! You have successfully registered!", welcome_text, f"Text should be \"Congratulations! You have successfully registered!\", got {welcome_text}")
